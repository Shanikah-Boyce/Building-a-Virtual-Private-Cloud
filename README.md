...
Flow Logs are currently enabled only on the public subnet, limiting visibility into internal traffic. This gap makes it harder to detect internal anomalies or troubleshoot access issues.
